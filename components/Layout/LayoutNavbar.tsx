import { Center, Container, Flex, Menu } from '@mantine/core';
...
export default function LayoutNavbar() {
  ...
  return (
    <Container size="xl" my="auto">
      <Flex className="logo_items" my="auto">
        <Flex my="auto">
          <Link href="/">
            <Flex>
              <Center my="auto">
                <Image src="/img/icon/ic-gedung.svg" width={32} height={32} alt="" priority />
              </Center>
              <Center my="auto" ml={8} className="logo_name my-auto">
                <svg
                  width="55"
                  height="16"
                  viewBox="0 0 55 16"
        ...
        <Flex ml="auto">
          <Menu width={200} offset={-10} withArrow>
            <Menu.Target>
              <UserMenu name={profile?.fullname} deskripsi={profile?.role} />
            </Menu.Target>
            <Menu.Dropdown>
              <Menu.Item
