...
import { MantineProvider, AppShell, Center, Flex, Avatar, Text, Menu } from '@mantine/core';
            ...
            >
              ...
              >
                ...
                <div className="menu_container">
                  ...
                  <Menu width={200} offset={-10} withArrow>
                    <Menu.Target>
                      <div className="sidebar_profile cursor-pointer flex">
                        ...
                        <div className="data_text">
                          ...
                          <Text size="xs">{profile?.role}</Text>
                        </div>
                        <IconChevronUp size="1rem" style={{ margin: 'auto 0 auto auto' }} />
                      </div>
                    </Menu.Target>
                    <Menu.Dropdown>
                      <Menu.Item
