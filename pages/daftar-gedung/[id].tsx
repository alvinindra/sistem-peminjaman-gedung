...
import { AppShell, Center, Container, Flex, Image, Menu } from '@mantine/core';
          ...
          <AppShell.Header>
            <Container size="xl" my="auto">
              <Flex className="logo_items">
                <Center my="auto">
                  <Image src="/img/icon/ic-gedung.svg" width={32} height={32} alt="" />
                </Center>
                ...
                <Flex ml="auto">
                  <Menu width={200} offset={-10} withArrow>
                    <Menu.Target>
                      <UserMenu name="Harriette Spoonlicker" deskripsi="Admin" />
                    </Menu.Target>
                    <Menu.Dropdown>
                      <Menu.Item
